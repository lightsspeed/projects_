...
const Hero = () => {
  return (
    <div className='flex flex-col items-start justify-center px-6 md:px-16 lg:px-24 xl:px-32 text-white bg-[url("/src/assets/heroImage.png")] bg-cover bg-center h-screen'>
        <p className='bg-[#49B9FF]/50 px-3.5 py-1 rounded-full mmt-20'>The Ultimate Hotel Experience</p>
        ...
        <p className='font-playfair max-w-130 mt-2 text-sm md:text-base'>Unparalleled luxury and comfort await at the world's most exquisite hotels. Experience the epitome of hospitality and indulge in a world of opulence.</p>
